...
export default class StaticLookup extends Lookup {
    ...
    check(context, parser_state = new Set(), doc = null) {
        ...
        if(this.what instanceof Variable) {
            ...
            return new ContextTypes(new PHPType.Mixed(null, null, "staticlookup#$x::$y").union)
        } else if(
        ...
        if(this.offset instanceof ConstRef) {
            if(class_context) {
                ...
                if(types && !types.isMixed) {
                    ...
                    return new ContextTypes(new PHPType.Mixed(null, null, "staticlookup#inaccessible").union)
                }
            }
        } else if(
            class_context &&
