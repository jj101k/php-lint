export namespace NodeTypes {
    ...
    type Error = {message: string, line: number, token: number | string, expected: string | Array<any>}
    ...
    export type Node = Block | Declaration | Expression | Assign | Echo | Include | If | Call
}